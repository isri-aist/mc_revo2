              ...
              std::string(mc_rtc::REVO2_DESCRIPTION_PATH) + "/urdf/" + revo2Variant(variant) + ".urdf")
{
  ...
  _ref_joint_order = {
      ...
      side + "_index_proximal_joint",   side + "_index_distal_joint",   side + "_middle_proximal_joint",
      side + "_middle_distal_joint",    side + "_ring_proximal_joint",  side + "_ring_distal_joint",
